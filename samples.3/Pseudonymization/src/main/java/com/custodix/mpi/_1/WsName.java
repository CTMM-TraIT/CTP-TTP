...
/**
 * <p>Java class for wsName complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="wsName">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="firstName" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="fullName" type="{http://www.custodix.com/MPI/1.0}wsFullName" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="initials" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="lastName" type="{http://www.custodix.com/MPI/1.0}wsLastName" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="maidenName" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="middleName" type="{http://www.custodix.com/MPI/1.0}wsMiddleName" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="nickName" type="{http://www.custodix.com/MPI/1.0}wsNickName" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="title" type="{http://www.custodix.com/MPI/1.0}wsTitle" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class WsName {
    ...
    protected List<WsFullName> fullName;
    protected String initials;
    protected List<WsLastName> lastName;
    protected String maidenName;
    protected List<String> middleName;
    protected List<String> nickName;
    protected List<WsTitle> title;
     ...
     * 
     */
    public List<WsFullName> getFullName() {
        if (fullName == null) {
            fullName = new ArrayList<WsFullName>();
        }
     ...
     * 
     */
    public List<WsLastName> getLastName() {
        if (lastName == null) {
            lastName = new ArrayList<WsLastName>();
        }
     ...
     * 
     */
    public List<WsTitle> getTitle() {
        if (title == null) {
            title = new ArrayList<WsTitle>();
        }
        return this.title;
    }
